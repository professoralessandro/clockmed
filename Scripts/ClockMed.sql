...
-- -----------------------------------------------------
-- Table `ClockMed`.`PrescricaoMedica`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ClockMed`.`PrescricaoMedica` (
...
-- -----------------------------------------------------
-- Table `ClockMed`.`AplicacaoEfefiva`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ClockMed`.`AplicacaoEfefiva` (
  ...
  INDEX `fk_AplicacaoEfefiva_PrescricaoMedica1_idx` (`idPrescricaoMedica` ASC) VISIBLE,
  CONSTRAINT `fk_Aplicacao_usuarios1`
    FOREIGN KEY (`idPaciente`)
    REFERENCES `ClockMed`.`usuarios` (`idUsuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Aplicacao_Medicamentos1`
    FOREIGN KEY (`idMedicamento`)
    REFERENCES `ClockMed`.`Medicamentos` (`idMedicamento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_AplicacaoEfefiva_PrescricaoMedica1`
    FOREIGN KEY (`idPrescricaoMedica`)
    REFERENCES `ClockMed`.`PrescricaoMedica` (`idPrescricaoMedica`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ClockMed`.`AplicacaoPreecrita`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ClockMed`.`AplicacaoPreecrita` (
  `idAplicacao` INT NOT NULL,
  ...
  `quantidade` DECIMAL(10,2) NULL,
  `observacoes` TEXT NULL,
  `PrescricaoMedica_idPrescricaoMedica` INT NOT NULL,
  PRIMARY KEY (`idAplicacao`),
  INDEX `fk_Aplicacao_usuarios1_idx` (`idPaciente` ASC) VISIBLE,
  INDEX `fk_Aplicacao_Medicamentos1_idx` (`idMedicamento` ASC) VISIBLE,
  INDEX `fk_AplicacaoPreecrita_PrescricaoMedica1_idx` (`PrescricaoMedica_idPrescricaoMedica` ASC) VISIBLE,
  CONSTRAINT `fk_Aplicacao_usuarios10`
    FOREIGN KEY (`idPaciente`)
    REFERENCES `ClockMed`.`usuarios` (`idUsuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Aplicacao_Medicamentos10`
    FOREIGN KEY (`idMedicamento`)
    REFERENCES `ClockMed`.`Medicamentos` (`idMedicamento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_AplicacaoPreecrita_PrescricaoMedica1`
    FOREIGN KEY (`PrescricaoMedica_idPrescricaoMedica`)
    REFERENCES `ClockMed`.`PrescricaoMedica` (`idPrescricaoMedica`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
