...
-- -----------------------------------------------------
-- Table `ClockMed`.`AplicacoesPrescritas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ClockMed`.`AplicacoesPrescritas` (
  `idAplicacaoPrescrita` INT NOT NULL,
  ...
  `idPrescricaoMedica` INT NOT NULL,
  PRIMARY KEY (`idAplicacaoPrescrita`),
  ...
  CONSTRAINT `fk_Aplicacao_Medicamentos10`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_AplicacaoPrescrita_PrescricaoMedica1`
